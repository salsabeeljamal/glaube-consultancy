...
const About = (props) => {
    ...
    return (
        <section className="about pos-rel pt-140" id="About_Us">
            <div className="container">
                <div className='d-flex flex-wrap'>
                <div className="col-xl-8 col-lg-8 sec-title sec-title--big style-2 mb-20">
                    ...
                    <div className='d-flex flex-wrap gap-4 align-items-center mt-20'>
                        ...
                        <div className="col-lg-6">
                            <div className="xb-about-content">
                                <p className='text-wrap'>Unlock Your Educational Journey Abroad: The Essential Student Visa GuideYour Gateway to Global Learning</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col-sm-12 col-lg-4 d-flex align-items-center justify-content-center">
                    <div className="xb-about-img">
                        <Image src={about} alt="" style={{ width: "380px" }} />
                    </div>
                </div>
                </div>
